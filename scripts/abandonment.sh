...
gzip >data/main/Pkg2cPtAbfl.${batch}.${ver}; # wc -l 25,576,498,510
end=$(date +%s);
...
echo "Elapsed time: $((end - start)) seconds"; # 105057 seconds
...
echo "Elapsed time: $((end - start)) seconds"; # 155141 seconds
